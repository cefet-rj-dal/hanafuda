...
public class RandomPlayer extends Player {
    ...
    public void move(GameStates currentState, Table table, Player otherPlayer) {
        ...
        if (currentState == GameStates.MatchDeckTable || currentState == GameStates.DiscardDeckCard){
	        ...
	        if (currentState == GameStates.DiscardDeckCard) {
		         
		        // se n�o houve combina��o, deixar a carta na mesa
		        
	            game.leaveOnTable(this, deckCard);
	        } else  if (currentState == GameStates.MatchDeckTable){
	            //Se existe combina��o poss�vel, escolhe aleatoriamente uma das combina��es possiveis
