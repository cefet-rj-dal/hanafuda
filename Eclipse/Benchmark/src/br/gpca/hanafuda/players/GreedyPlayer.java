...
public class GreedyPlayer extends Player {
    ...
    public GreedyPlayer(GameController game) {
        super(game);
    }
    ...
    public void move(GameStates currentState, Table table, Player otherPlayer) {
	...
	} else if (currentState == GameStates.DiscardHandCard){
        ...
        }else if (currentState == GameStates.MatchDeckTable || currentState == GameStates.DiscardDeckCard){
        ...
        //if (game.buyFromDeck() == ErrorList.Success) {
            deckCard = game.getDeckCard(); // obter carta do topo do monte
        //}
